...
public class BaralhoTest {
	...
	@Test
	public void validarQuantidadeCartasBaralhoCheio() throws SemCartaException {
		cut.embaralhar();
		int cont = 0;
		while(cut.hasCarta()) {
	...
	@Test
	public void validarRemocaoCartasBaralhoVazio() throws SemCartaException {
	    cut.embaralhar();
	        while (cut.hasCarta()) {
	            cut.distribuirCarta();
	        }
	        assertFalse(cut.hasCarta());
	        assertThrows(SemCartaException.class, () -> {
	            cut.distribuirCarta();
	        });
	}
